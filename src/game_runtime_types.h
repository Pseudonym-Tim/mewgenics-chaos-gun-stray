...
#define MOD_NAME "Configurable Stray Coordinator"

// Function RVAs (Relative to game module base from MJ_GetGameBase)...
#define RVA_CREATE_STRAY_CATDATA 0x0D5540u // CatDatabase helper: alloc/init a new stray CatData using chosen sex...
#define RVA_SCENE_CREATE_ENTITY 0x95AFE0u // Scene primitive entity constructor used before HouseCat bind...
#define RVA_SCENE_CREATE_HOUSECAT_I64 0x1F3A70u // House Scene: Attach CatData to spawned HouseCat entity...
#define RVA_CATDATA_UNK_INIT 0x0B5260u // CatData init routine used by custom-cat application path (reverse engineered)...
#define RVA_CUSTOM_CAT_LOOKUP 0x936540u // Lookup by key in custom_cats tree/root...
#define RVA_APPLY_CUSTOM_CATDATA 0x733B50u // Copy template data from custom cat into CatData custom compartment...
#define RVA_INIT_NARROW_STRING 0x052640u // Construct NarrowString from ASCII literal/key text...
#define RVA_DESTROY_NARROW_STRING 0x0522D0u // NarrowString destructor for temporary key buffers...
#define RVA_LOCALIZE_NARROW_KEY 0x956270u // Localization manager: Key -> localized WideString...
#define RVA_ASSIGN_WIDE_STRING 0x0623C0u // WideString assignment helper used after localization/name generation...
#define RVA_DESTROY_WIDE_STRING 0x051DE0u // WideString destructor for localized temporaries...
#define RVA_CHARACTER_GET_CURRENT_HP_FALLBACK 0x0D1430u // Safe HP accessor used when computing spawn-time derived stats...

// Global/static data offsets (Absolute pointer at gameBase + offset)...
#define DATAOFF_LOCALIZATION_MANAGER 0x13B2590u // Singleton localization manager used for key->text resolution...
#define DATAOFF_MEWDIRECTOR_SINGLETON 0x13C7BD0u // MewDirector singleton used to find scenes/cat database...
#define DATAOFF_CUSTOM_CATS_ROOT 0x13B4A10u // Root object that owns the custom-cat lookup container...
